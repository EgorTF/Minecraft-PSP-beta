...
public:
    ...
    char material;              // материал блока (1 - дерево, 2 - камень, 3 - земля, 4 - листва, 5 - обсидиан, 6 - бедрок)
    ...
    char blockModel;            // модель блока (0 - стандартный куб, 1 - полублок, 2 - забор, 3 - крестовой объект(цветок, саженец), 4 - модель пшеницы, 5 - особый блок, модель которого вы можете найти в CraftWorld2.cpp)
    char refraction;
